...
class NumbaLinalg:
    ...
    @staticmethod
    def cg(indptr, indices, data, b, x, indexes, rtol=None, atol=1e-6, maxiter=100):
    ...
    @staticmethod
    def preconditioned_cg(indptr, indices, data, b, x, indexes, M, rtol=None, atol=1e-6, maxiter=100):
