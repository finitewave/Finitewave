...
@njit(parallel=True)
def compute_ecg_2d(u_tr, u, coords, dr, indexes, distance_power=1):
    """
...
def compute_ecg_3d(u_tr, u, coords, dr, indexes, distance_power=1):
    """
