...
from ..stencil2D.isotropic_stencil_2d import (
    IsotropicStencil2D,
    compute_component
)
...
class IsotropicStencil3D(IsotropicStencil2D):
    ...
    def diffusion_kernel(self, u_new, u, rhs, w, indexes):
        ...
        """
        return diffusion_kernel_3d_iso(u_new, u, rhs, w, indexes)
    ...
    def compute_weights(self, simulation):
        ...
        weights = np.zeros((*mesh.shape, 7), dtype=simulation.npfloat)
...
@njit(parallel=True)
def diffusion_kernel_3d_iso(u_new, u, rhs, w, indexes):
    """
