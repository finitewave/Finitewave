...
from finitewave.gridywave.stencil.stencil2D.isotropic_stencil_2d import (
    IsotropicStencil2D,
    compute_component
)
...
class IsotropicStencil3D(IsotropicStencil2D):
    ...
    def select_diffusion_kernel(self):
        ...
        """
        return diffusion_kernel_iso_3d_fdm
...
@njit(parallel=True)
def diffusion_kernel_iso_3d_fdm(u_new, u, w, indexes):
    """
