...
tissue = fw.CardiacTissueFDM([n, nj, nk])
...
stim_sequence.add_stim(fw.StimVoltageCoordFDM(time=0, volt_value=1, x1=0, x2=3,
                                              y1=0, y2=nj, z1=0, z2=nk))

tracker_sequence = fw.TrackerSequence()
act_time_tracker = fw.ActivationTimeTrackerFDM()
