...
tissue = fw.CardiacTissueFDM([n, n, nk])
...
stim_sequence.add_stim(fw.StimVoltageCoordFDM(0, 1, 0, n, 0, n//2, 0, nk))
stim_sequence.add_stim(fw.StimVoltageCoordFDM(31, 1, 0, n//2, 0, n, 0, nk))

tracker_sequence = fw.TrackerSequence()
spiral_3d_tracker = fw.SpiralWaveCoreTrackerFDM()
